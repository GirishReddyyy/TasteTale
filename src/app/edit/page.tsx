...
export default function AdminDashboard() {
  ...
  if (loading) {
    return <div className="min-h-screen bg-[var(--color-bg-paper)] flex items-center justify-center text-[var(--color-text-body)]">Loading...</div>;
  }
            ...
            {recipes.map((recipe) => (
              <div key={recipe._id} className="relative group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border-2 border-dashed border-[var(--color-secondary)] flex flex-col">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto grid grid-cols-2 gap-2 pt-4 border-t-2 border-dashed border-[var(--color-secondary)]/50">
                    <Link
                      href={`/edit/${recipe.slug}`}
                      className="flex items-center justify-center gap-2 py-2 rounded-lg font-bold text-[var(--color-text-body)] hover:bg-[var(--color-secondary)]/20 transition-colors"
                    >
